...
const EditClient = props => {
  ...
  return(
    <Fragment>
      <form id='edit_company_division_client' className={ baseClasses.root } action={ `/company_division_clients/${ props.client.id }` } acceptCharset='utf8' method='post'>
