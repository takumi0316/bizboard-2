        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <div className='u-mt-15'>
                { props.show ?
                  <textarea placeholder='2000' className='c-form-textarea' disabled={ props.lock? 'disabled' : null} onChange={ e => props.setDiscount(e.target.value) } type='text' defaultValue={ props.discount } />
                  : null
                }
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <textarea placeholder='利益額' className='c-form-textarea' disabled={ props.lock? 'disabled' : null} onChange={ e => props.setProfitPrice(e.target.value) } type='text' defaultValue={ props.profit_price } />
            </td>
          </tr>
          <tr>
            ...
            <td>
							<textarea placeholder='案件に関する備考を入力してください ※見積もりに記載されます' className='c-form-textarea' row={5}
												autoComplete='off' spellCheck='false' type='text' defaultValue={ props.remarks } disabled={ props.lock? 'disabled' : null} onBlur={ e => props.setRemarks(e.target.value) }
							/>
            </td>
          </tr>
          <tr>
