      ...
      <React.Fragment>
        ...
        { this.props.type == 'button' ?
          ...
          <div className={Style.DatetimePicker__input}>
            <input type='text' className={ `${this.props.class ? this.props.class : 'c-form-text'} u-ta-center` } name={this.props.name} ref={ node => this.inputRef = node} defaultValue={ Dayjs(this.props.default_datetime).format("YYYY-MM-DD")  || '' } onClick={this.open} readOnly={true} placeholder='日付を選択' />
          </div>
        }
      </React.Fragment>
    );
