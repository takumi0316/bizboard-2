  ...
  const saveContent = e => {
    ...
    state.contents.map((content, index) => {
      ...
      if(content.content_type === 'image') {
        ...
        if(doc.dataset.set === 'no_image') {
          field.append('company_division_client[layout_values_attributes][][upload_url]', '')
          field.append('company_division_client[layout_values_attributes][][upload_id]', '')
        } else {
          field.append('company_division_client[layout_values_attributes][][upload_url]', doc.src)
