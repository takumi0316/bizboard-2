 ...
 *  @version 2018/06/10
 */
export default class DivisionEdit extends React.Component {
   ...
   */
    ...
    onClientUpdate = e => {
      ...
      const field = new FormData();
      field.append('company_division[company_id]', this.state.company.id);
      field.append('company_division[name]', this.state.division.name);
      field.append('company_division[kana]', this.state.division.kana);
      field.append('company_division[zip]', this.state.division.zip);
      field.append('company_division[prefecture_id]', this.state.division.prefecture_id);
      ...
      const url = '/company_divisions/' + this.state.division.id;
    ...
    return (
      <div>
        { this.state.show_modal ?
          <div className='c-overlay-edit'>
            <div className='c-overlay-content'>
              <div className='u-px-25'>
                <form class="u-mt-30" id="new_company_division" action="/company_divisions" accept-charset="UTF-8" method="post"/>
                  <div>
                  <h2 class="l-dashboard__heading">部署</h2>
                    ...
                    <div className='c-form-selectWrap u-mb-30'>
                      <select name='company_id' className='c-form-select' defaultValue={ this.props.company.id } disabled>
                  ...
                  <div>
                    { this.state.division.company_id == null ?
                      <div>
          ...
          { this.state.division.company_id == null ?
            <div>
              <button className='c-btnMain c-btn-blue' onClick={(client_id) => {this._openModal(client_id)}}>部署を追加</button>
            </div>
          :
            <div>
