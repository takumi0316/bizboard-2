...
export default class ClientGenerate extends React.Component {
  ...
  onChangeValue = (e, value_index) => {
    ...
    this.setState({ template: template, change_status: true }, () => drawTextValue(template.values[value_index], document.getElementById('pdf'), document.getElementById('draw'), value_index));
  };
