...
export const addQuoteProject = (e, quote, setQuote) => {
  ...
  quote_projects .push(QUOTE_PROJECT)
...
export const applyQuoteProject = (index, tarProject, quote, setQuote) => {
  ...
  quote_projects.forEach(project => total_price = total_price + (project.unit_price + project.unit))
  setQuote({ quote_projects: quote_projects, price: total_price })
}
