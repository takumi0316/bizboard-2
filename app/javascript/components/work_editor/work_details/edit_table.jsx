          ...
          <tbody>
            { props.work_details ?
              <Fragment>
                  ...
                  return (
                    <tr { ...{key} }>
                      <td className='u-va-middle'>
                        <button className='c-btnMain c-btn-red' value={ detail.id } onClick={ e => props.onConfirm(e, index) }>削除</button>
                      </td>
                ...
                <tr>
                  <td colSpan='13'>
                    <button className='c-btnMain c-btn-blue' onClick={ e => props.onWorkDetailCreate(e) }>行を追加</button>
                  </td>
                </tr>
              </Fragment>
              : null
