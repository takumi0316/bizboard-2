...
export default class ClientSearch extends React.Component {
  ...
  _onSelect = e => {
    ...
    this.props.applyClient(client, this.props.index);
    this._close();
  }
  ...
  render () {
    ...
    return (this.state.show ?
      <div className={Style.ClientSearch} onClick={ e => this._close }>

          { this.state.type ? <SubcontractorBulk closeBulk={ this._closeBulk } users={ this.props.users } prefectures={ this.props.prefectures } applyClient={ this.props.applyClient } work_subcontractor_id={ this.props.work_subcontractor_id } close={ this._close } companies={ this.state.companies } /> : null}
          ...
          { this.state.body == null ?
            <div>
              <div className={Style.ClientSearch__form}>
                ...
                <div onClick={ e => this._openBulk(e) } className='c-btnMain-standard c-btn-blue u-ml-50'>外注先情報を作成する</div>
              </div>
                  ...
                  {this.state.clients.map((client, i) => {
                    ...
                    return (
                      <li {...{key}} className={Style.ClientSearch__item}>
                        <h2 className={Style.ClientSearch__itemName} data-number={i} onClick={ e => this._onSelect(e) }>{client.company.name} {client.division.name} {client.name} 様</h2>
                      </li>
                    );
                  })}
                </ul>
      ...
      :
      <div className='c-btnMain-standard' onClick={ e => this._open(e) }>外注先情報</div>
    );
  }
}
