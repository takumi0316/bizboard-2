      ...
      { props.itemStatus ?
        <div className='c-table u-mt-30'>
          <table>
            ...
            <tbody>
              <Specifications lock={ props.lock } quote_projects={ props.quote_projects } quote_id={ props.quote_id } setName={ props.setName } setQuoteRemarks={ props.setQuoteRemarks }
