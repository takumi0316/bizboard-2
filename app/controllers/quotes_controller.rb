    ...
    if params[:id] == 'null'
      ...
      unless params[:specifications].nil?
        params[:specifications].each do |specification|
          ...
          createQuote.quote_projects.create!(name: parse_json['projectSpecificationName'], unit_price: parse_json['projectSpecficationUnitPrice'].to_i, unit: parse_json['projectSpecificationUnit'].to_i, price: parse_json['projectSpecificationPrice'].to_i, project_id: parse_json['projectSpecificationId'], project_name: parse_json['projectName'])
        end
      end
      ...
      unless params[:specifications].nil?
        params[:specifications].each do |specification|
          ...
          if findQuoteProject.id == 0
            ...
            QuoteProject.create!(name: parse_json['projectSpecificationName'], unit_price: parse_json['projectSpecificationUnitPrice'].to_i, unit: parse_json['projectSpecificationUnit'].to_i, price: parse_json['projectSpecificationPrice'], quote_id: params[:id], project_id: parse_json['projectSpecificationId'], project_name: parse_json['projectName'])
          else

            findQuoteProject.update!(name: parse_json['projectSpecificationName'], unit_price: parse_json['projectSpecificationUnitPrice'], unit: parse_json['projectSpecificationUnit'], price: parse_json['projectSpecificationPrice'], project_id: parse_json['projectSpecificationId'], project_name: parse_json['projectName'])
          end
        end
      end
