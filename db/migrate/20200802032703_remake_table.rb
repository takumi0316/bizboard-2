class RemakeTable < ActiveRecord::Migration[5.2]
  ...
  def up
    ...
    create_table :layout_logos, options: 'DEFAULT CHARSET=utf8mb4' do |t|
    ...
    create_table :layout_flags, options: 'DEFAULT CHARSET=utf8mb4' do |t|
    ...
    create_table :card_layouts, options: 'DEFAULT CHARSET=utf8mb4' do |t|
      ...
      t.references :card_template,      index: true
      t.references :layout_logo,        index: true
      t.references :layout_flags,       index: true
  ...
  def down
   ...
   drop_table :layout_logos, options: 'DEFAULT CHARSET=utf8mb4' do |t|
   ...
   drop_table :layout_flags, options: 'DEFAULT CHARSET=utf8mb4' do |t|
   ...
   drop_table :card_layouts, options: 'DEFAULT CHARSET=utf8mb4' do |t|
    ...
    t.references :card_template,      index: true
    t.references :layout_logo,        index: true
    t.references :layout_flag,        index: true
    t.string     :name,               comment: 'レイアウトの名前'
    t.string     :x_coordinate,       comment: '座標(X)'
    t.string     :y_coordinate,       comment: '座標(Y)'
    t.string     :font_family,        comment: '書体'
