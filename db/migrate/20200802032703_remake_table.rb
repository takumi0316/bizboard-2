class RemakeTable < ActiveRecord::Migration[5.2]
  ...
  def up
    ...
    create_table :card_template_layouts, options: 'DEFAULT CHARSET=utf8mb4' do |t|
    ...
    create_table :template_layout_logo, options: 'DEFAULT CHARSET=utf8mb4' do |t|

      t.references :card_template_layout, index: true

      t.timestamp
    end

    create_table :card_information,  options: 'DEFAULT CHARSET=utf8mb4' do |t|
  ...
  def down
    ...
    drop_table :card_template_layouts, options: 'DEFAULT CHARSET=utf8mb4' do |t|
    ...
    drop_table :template_layout_logo, options: 'DEFAULT CHARSET=utf8mb4' do |t|
    ...
    drop_table :card_information,  options: 'DEFAULT CHARSET=utf8mb4' do |t|
